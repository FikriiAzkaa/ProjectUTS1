...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Bulan Mei 2023 pada 16.00
...
(1, 'TY01', 'TOYOTASUPRA', 6700000, 6000000, 10, 2, 'Toyota Supra', 1),
(2, 'KWS01', 'KAWASAKI', 5300000, 5000000, 6, 1, 'Kawasaki H2R', 1),
(3, 'NSN01', 'NISSAN SKYLAN', 6000000, 5500000, 10, 1, 'Nissan Skylan GTR34', 1),
(4, 'CRV01', 'CAR VELG', 980000, 900000, 10, 1, 'Car Velg', 1),
(5, 'VM01', 'VELG MOTOR', 980000, 900000, 20, 1, 'Velg Motor', 1);
